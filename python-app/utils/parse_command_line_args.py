...
def parse_command_line_args():
    ...
    arg_parser.add_argument("--bootstrap-servers", required=False, default="my-kafka-cluster-kafka-bootstrap:9092", help="Bootstrap server address")
    arg_parser.add_argument("--schema-registry", required=False, default="http://my-sreg-schema-registry:8081", help="Schema Registry url")
